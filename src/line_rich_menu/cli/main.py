...
@click.option("-t", "--token", required=False, type=str,
...
@main_cli.command()
@click.option("-d", "--data", type=click.Path(exists=True),
              help="Rich menu object in json format, see https://developers.line.biz/en/reference/messaging-api/#rich-menu-object")  # noqa
